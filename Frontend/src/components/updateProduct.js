                          ...
                          <div className="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                            ...
                            <div>
                              ...
                              <input
                                ...
                                name="name"
                                id="name"
                                className="block w-full px-4 py-2 mt-2 text-gray-700 border border-gray-200 rounded-md bg-gray-200 dark:text-gray-00 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring"
                                value={product.name}
                                onChange={(e) =>
                                  setProduct({
                                    ...product,
